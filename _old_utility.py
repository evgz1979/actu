...
def get_s1(symbol_name):  # ---- @
    response = urllib.request.urlopen("https://api.binance.com/api/v3/exchangeInfo?symbol="+symbol_name).read()
    return json.loads(response)['symbols']
