...
#
#
# class MoneyMethod(TAnalysisMethod):
#     id = 'MONEY'
#
#     def calc(self):
#         if len(self.candles) > 2:
...
#
#
# class TemplateMethod(TAnalysisMethod):  # (SourceTrace)
...
#
#
# class StreamMethod(TAnalysisMethod):
#     id = 'STREAM'
#
#     @staticmethod
...
#
#
# class TendencyMethod(TAnalysisMethod):
#     id = 'TENDENCY'
#
...
#
#
# class CorrectionMethod(TAnalysisMethod):
#     id = 'CORRECTION'
#
#
# class AbstractFlowMethod(TFlowDonwgradeMethod):
...
#
#
# class VolkSystem(TAnalysisSystem):
#
